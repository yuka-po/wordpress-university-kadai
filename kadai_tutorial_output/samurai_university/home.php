<!-- header.php ここから -->
    ...
    <!-- 数字 -->
    <div class="counter">
      <div class="counter_background" style="background-image: url(<?php echo get_template_directory_uri();?>/images/pic_chart.png)"></div><img src="<?php echo get_template_directory_uri(); ?>/images/icon4.png" alt="" />
      <div class="footer_row">
        <div class="">
          <div class="">
